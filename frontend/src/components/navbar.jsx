                        ...
                        {isLogin ? (
                            <div className="flex items-center space-x-4">
                                ...
                                <button 
                                    ...
                                    className="flex items-center space-x-2 bg-white/10 hover:bg-red-500 text-white px-6 py-3 rounded-full border border-white/20 hover:border-red-400 font-medium transition-all duration-300 hover:shadow-lg group"
                                >
                    ...
                    <div className="md:hidden flex items-center space-x-2">
                        {isLogin ? (
                            <div className="flex items-center space-x-2">
                                ...
                                <button 
                                    onClick={handleLogout} 
                                    className="flex items-center space-x-1 bg-white/10 hover:bg-red-500 text-white px-3 py-2 rounded-full text-xs font-medium transition-all duration-300"
                                >
